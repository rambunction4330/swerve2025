...
public:
  ...
  std::array<rmb::SwerveModule, NumModules> &getModulesMut() { return modules; }
  ...
  // void turnModuleAsCenter(frc::ChassisSpeeds chassisSpeeds,
  ...
  void turnAroundModule(size_t module, units::turns_per_second_t v);
