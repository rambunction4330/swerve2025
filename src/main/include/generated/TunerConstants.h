...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 4_mps;
...
private:
    ...
    static constexpr int kPigeonId = 2;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.04052734375_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 12.75_in;
    static constexpr units::inch_t kFrontLeftYPos = 12.75_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = 0.028564453125_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 12.75_in;
    static constexpr units::inch_t kFrontRightYPos = -12.75_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.400390625_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -12.75_in;
    static constexpr units::inch_t kBackLeftYPos = 12.75_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = 0.4814453125_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -12.75_in;
    static constexpr units::inch_t kBackRightYPos = -12.75_in;
